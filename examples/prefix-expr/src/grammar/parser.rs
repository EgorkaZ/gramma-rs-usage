...
let dfa = {
    let states = vec![
        (Some(UnitId(7)), vec![(9, 23),(6, 21),(21, 13),(19, 0),]),
        (Some(UnitId(25)), vec![]),
        (Some(UnitId(21)), vec![]),
        (Some(UnitId(4)), vec![]),
        (Some(UnitId(9)), vec![]),
        ...
        (Some(UnitId(15)), vec![]),
        (Some(UnitId(30)), vec![]),
        (None, vec![(0, 22),(4, 18),(10, 12),(11, 6),(2, 4),(7, 5),(12, 2),(22, 10),(24, 20),(1, 1),(14, 3),(15, 26),(13, 15),(18, 16),(3, 11),(17, 24),(5, 14),(20, 27),(16, 7),(9, 8),(8, 25),(6, 19),(19, 9),]),
        (Some(UnitId(37)), vec![]),
        (Some(UnitId(34)), vec![(6, 19),]),
        (Some(UnitId(20)), vec![]),
        (Some(UnitId(7)), vec![(9, 23),(6, 21),(21, 13),(19, 0),]),
        (Some(UnitId(36)), vec![]),
        (Some(UnitId(7)), vec![(9, 23),(6, 21),(21, 13),(19, 0),]),
