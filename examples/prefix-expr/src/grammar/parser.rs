...
let dfa = {
    let states = vec![
        (Some(UnitId(21)), vec![]),
        (Some(UnitId(34)), vec![(16, 1),]),
        (Some(UnitId(7)), vec![(17, 15),(16, 13),(13, 10),(15, 11),]),
        (Some(UnitId(22)), vec![]),
        (Some(UnitId(24)), vec![]),
        (Some(UnitId(8)), vec![]),
        (Some(UnitId(17)), vec![]),
        ...
        (Some(UnitId(7)), vec![(17, 15),(16, 13),(13, 10),(15, 11),]),
        (Some(UnitId(7)), vec![(17, 15),(16, 13),(13, 10),(15, 11),]),
        (None, vec![(11, 19),(8, 17),(6, 23),(20, 5),(0, 21),(7, 25),(3, 0),(19, 4),(23, 7),(1, 24),(14, 22),(22, 6),(24, 9),(12, 27),(2, 26),(9, 14),(21, 18),(18, 3),(4, 16),(17, 2),(5, 20),(16, 1),(15, 8),]),
        (Some(UnitId(7)), vec![(17, 15),(16, 13),(13, 10),(15, 11),]),
        (Some(UnitId(29)), vec![]),
        (Some(UnitId(7)), vec![(17, 15),(16, 13),(13, 10),(15, 11),]),
        (Some(UnitId(23)), vec![]),
...
{
    pub fn new() -> Self
    { ExprParser{ base: create_parser_base().set_sym::<_Data, Tree>() } }
